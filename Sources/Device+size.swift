extension Device {
    ...
    public var diagonal: Double {
        ...
        case let .simulator(device): return device.diagonal
    ...
    public var screenSize: ScreenSize {
        ...
        case let .simulator(device): return device.screenSize
        case .unknown: return ScreenSize(width: -1, height: -1)
        }
    }
    ...
    public var ppi: Int {
        ...
        case let .simulator(device): return device.ppi
        case .unknown: return -1
        }
    }
    ...
    public var cornerRadius: Double {
        ...
        case let .simulator(device): return device.cornerRadius
        default: return 0
        }
    }
}
